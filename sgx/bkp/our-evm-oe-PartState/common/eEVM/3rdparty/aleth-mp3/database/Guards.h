...
using ReadGuard = std::unique_lock<std::mutex>;
using UpgradableGuard = std::unique_lock<std::mutex>;
using UpgradeGuard = std::unique_lock<std::mutex>;
using WriteGuard = std::unique_lock<std::mutex>;

// IH: boost stuff replaced
