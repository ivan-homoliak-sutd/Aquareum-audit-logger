...
namespace aql
{
    ...
    public:
        ...
        AQLedger m_ledger;                                               // Aquareum ledger instance
        std::unordered_map<eevm::Address, OperAccount> m_accounts;       // All testing simple accounts generated by O
        std::unordered_map<eevm::Address, ContrDefinition> m_contracts;  // All testing contract accounts generated by O (value is just reference)
        std::unordered_map<eevm::Address, unsigned char*> m_clients_accounts;
    ...
    private:
        ...
        void _sendMyPKtoEnclave(oe_enclave_t* enclave);
