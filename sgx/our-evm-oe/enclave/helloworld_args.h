...
typedef struct _ecall_read_pub_state_args_t
{
    oe_result_t _result;
    int _retval;
    PublicSealedData_T* evm_state_pub;
    size_t evm_state_size_pub;
} ecall_read_pub_state_args_t;
...
enum
{
    ...
    helloworld_fcn_id_ecall_read_pub_state = 1,
